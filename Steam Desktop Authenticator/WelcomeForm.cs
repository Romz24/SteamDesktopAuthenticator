...
namespace Steam_Desktop_Authenticator
{
    public partial class WelcomeForm : Form
    {
        ...
        private void btnImportConfig_Click(object sender, EventArgs e)
        {
            ...
            folderBrowser.Description = Strings.Get("WelcomeForm_SelectFolderDescription");
            ...
            if (userClickedOK == DialogResult.OK)
            {
                ...
                else
                {
                    ...
                    MessageBox.Show(Strings.Get("WelcomeForm_FolderInvalid"), Strings.Get("Common_Error"), MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                // All done!
                MessageBox.Show(Strings.Get("WelcomeForm_ImportedAll"), Strings.Get("WelcomeForm_ImportAccountsTitle"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                showMainForm();
            }
